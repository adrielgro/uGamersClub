Locales['es'] = {
  ...
  ['vault']                    = 'Chest',
  ['open_vault']               = 'Press ~ INPUT_CONTEXT ~ to access the box',
  ...
  ['max_item']                 = 'Youre already carrying enough on yourself.',
  ...
  ['e_to_enter']               = 'Press ~ g ~ E ~ w ~ to enter',
  ['e_to_ring']                = 'Press ~ g ~ E ~ w ~ to ring',

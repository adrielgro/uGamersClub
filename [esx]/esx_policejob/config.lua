...
Config.PoliceStations = {
  ...
  LSPD1 = {
    ...
    AuthorizedVehicles = {
	  { name = 'policiacanaria', label = 'Policia Local' },
  ...
  SASP1 = {
    ...
    AuthorizedVehicles = {
	  ...
	  { name = 'DPS1', label = 'Sheriff Crown victoria' },
      { name = 'DPS2', label = 'Sheriff ford Explorer double stacked' },
      { name = 'DPS3', label = 'Sheriff Ford Explorer' },
	  { name = 'DPS4', label = 'Sheriff Orange county' },
      { name = 'police2', label = 'LSPD1' },
      { name = 'police3', label = 'LSPD2' },
      { name = 'police4', label = 'LSPD3' },
	  { name = 'police5', label = 'LSPD4' },
	  { name = 'police6', label = 'LSPD5' },
	  { name = 'police8', label = 'LSPD6' },
	  { name = 'police7', label = 'LSPD7' },
	  ...
	  { name = 'hwaycar', label = 'CHP Crown Vic' },
	  { name = 'hwaycar2', label = 'CHP Dodge Charger' },
	  { name = 'hwaycar3', label = 'CHP Ford Explorer' },
	  { name = 'hwaycar4', label = 'CHP Ford Explorer ST' },
	  { name = 'hwaycar5', label = 'CHP Ford Explorer OLD' },
	  { name = 'hwaycar6', label = 'CHP Ford Explorer' },
	  { name = 'hwaycar7', label = 'CHP Crown Vic CL' },
	  { name = 'hwaycar8', label = 'CHP Dodge Charger ST' },
	  { name = 'hwaycar9', label = 'CHP Ford F-350' },
	  { name = 'hwaycar10', label = 'CHP Ford Crown Vic ST' },
	  ...
	  { name = 'hurkf350', label = 'f350' },
	  { name = 'cog552', label = 'Armored' },
	  { name = 'fbi', label = 'Unmarked X5' },
	  { name = 'fbi2', label = 'Unmarked suv' },
	  { name = 'sheriff5', label = 'Sheriff dodge' },

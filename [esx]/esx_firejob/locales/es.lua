Locales['es'] = {
  ...
  ['fire_clothes'] = 'Fireman Gear',
  ['fems_clothes_ems'] = 'Female Ambulance Gear',
  ['mems_clothes_ems'] = 'Male Ambulance Gear',
  ...
  ['evidence_out'] = 'take out of storage',
  ['evidence_in'] = 'put in storage',
  -- Boss Menu

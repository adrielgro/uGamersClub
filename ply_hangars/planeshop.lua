...
local planeshop = {
	...
	menu = {
		...
		["Civil"] = {
			...
			name = "Civil",
			buttons = {
				{name = "Cuban 800", costs = 1, description = {}, model = "cuban800"},
				{name = "Dodo", costs = 1, description = {}, model = "dodo"},
				{name = "Duster", costs = 1, description = {}, model = "duster"},
				{name = "Luxor", costs = 1, description = {}, model = "luxor"},
				{name = "Mammatus", costs = 1, description = {}, model = "mammatus"},
				{name = "Mil-Jet", costs = 1, description = {}, model = "miljet"},
				{name = "Nimbus", costs = 1, description = {}, model = "nimbus"},
				{name = "Shamal", costs = 1, description = {}, model = "shamal"},
				{name = "Velum", costs = 1, description = {}, model = "velum"},
				{name = "Vestra", costs = 1, description = {}, model = "vestra"},
			}
		},
		["Militaire"] = {
			title = "Militaire",
			...
			buttons = {
				...
				{name = "Titan", costs = 1, description = {}, model = "titan"},
			}
		},
	}
}
